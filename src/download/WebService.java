...
public class WebService {
     ...
     * @param prefixes
     * @param headVariables
     * @param headVariableToPosition
     * @param numberInputs
     */
    public WebService(String name, List<String> urlFragments, HashMap<String, String> prefixes, ArrayList<String> headVariables, HashMap<String, Integer> headVariableToPosition, int numberInputs, String sequence) {
        this.name = name;
    ...
    /**
     * constructor for convenience purposes -- if we do not want to read a
    ...
    /**
     * @param inputs
     * @return the file where the call result is stored; returns null if some
     * error occurs
     */
    ...
    public String getTransformationResult(String fileWithCallResult) throws Exception {
        ...
        Result transformResult = new StreamResult(new File(fileWithTransformationResult));

        Transformer transformer = TransformerFactory.newInstance().newTransformer(xsl);
        transformer.transform(callResult, transformResult);
     ...
     * @return downloads the file and stores it in the file. If the call result
     * is JSON, then transforms it to XML
     */
        ...
        try {
            ...
            if (line != null) {
                if (line.startsWith("{")) {
                    ...
                    System.out.println(fileForTheResults);
